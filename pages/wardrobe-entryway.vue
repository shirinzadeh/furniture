...
// Get category from URL - use a similar category if exact match doesn't exist
const categorySlug = 'storage'
const category = computed(() => categoriesStore.categories.find(c => 
  c.slug === categorySlug || c.slug === 'wardrobe' || c.slug === 'entryway'
))
